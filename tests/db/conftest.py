...
@pytest.fixture
def user2() -> UserModel:
    return UserModel(id=50, username="max444", active=False)
...
def all_notifications(
    ...
    notification3: NotificationModel,
) -> tuple[NotificationModel, NotificationModel, NotificationModel, NotificationModel]:
    return notification0, notification1, notification2, notification3
